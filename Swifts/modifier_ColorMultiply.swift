...
struct modifier_ColorMultiply: View {
    var body: some View {
        VStack {
            Spacer()
            VStack {
                Text("modifier_ColorMultiply")
                    .font(.title)
            ...
            VStack {
                ...
                Text("No modifier_ColorMultiply")
            }
            .padding()
            .background(BlurBg(style: .systemUltraThinMaterial))
            .cornerRadius(20)
            ...
            VStack {
                ...
                Text("With modifier_ColorMultiply\nColor(.systemYellow)")
                    .multilineTextAlignment(.center)
            }
...
struct modifier_ColorMultiply_Previews: PreviewProvider {
    static var previews: some View {
        modifier_ColorMultiply()
    }
}
